...
function extractValue(arr, key) {
    return arr.reduce(function(accum, indx){
        accum.push(indx[key]);
        return accum;
    }, []);
}
...
/*
Write a function called vowelCount which accepts a string and returns an object with the keys as the vowel and the values as the number of times the vowel 
appears in the string. This function should be case insensitive so a lowercase letter and uppercase letter should count
...
function addKeyAndValue(arr, key, value) {
    return arr.reduce(function(accum, obj, indx){
...
true, the value should be placed in the first subarray. If the result of the callback function at that specific value is false, the value should be placed in the second subarray. 
